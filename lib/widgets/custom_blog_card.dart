  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        bool isMobile = screenWidth < 800; // Mobile vs larger screen detection

        double padding =
            isMobile ? 10.0 : 20.0; // Adjust padding based on screen size
        double fontSize =
            isMobile ? 16.0 : 18.0; // Adjust font size for mobile vs PC
        double cardElevation =
            isLarge ? 8 : 4; // Larger card elevation for large screens
        double titleFontSize =
            isMobile
                ? fontSize + 4
                : fontSize + 6; // Larger title font size for larger screens
        double contentFontSize =
            isMobile ? 14.0 : 16.0; // Adjust content font size
        ...
        return Card(
          ...
          shadowColor:
              theme.isDarkTheme ? darkCardShadowColor : lightcardshadowColor,
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    // Wrap the GradientText widget with Expanded to prevent overflow
                    Expanded(
                      child: GradientText(
                        text: title,
                        fontSize:
                            titleFontSize, // Larger title font size for larger screens
                        fw: FontWeight.w600,
                      ),
                    ),
                    IconButton(
...
class CustomBlogCard extends StatefulWidget {
  ...
  final bool isLarge;
  final Timestamp createdAt;
  final List<String>? imageUrls; // Make imageUrls nullable
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                      ...
                      onPressed: () async {
                        ...
                        if (user == null) {
                          ...
                          await FirebaseFirestore.instance
                              ...
                              .doc(userUid)
                              .update({
                            'savedBlogs': FieldValue.arrayUnion([widget.blogId]),
                          });
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Blog saved successfully!'),
                ...
                // Content Text with "See More" functionality
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _showFullContent
