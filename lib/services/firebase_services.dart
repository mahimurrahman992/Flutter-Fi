...
// Function to create a new blog with an image URL
Future<void> createBlog({
 ...
 required List<String> imageUrls,  // Optional imageUrl parameter
}) async {
  try {
    await FirebaseFirestore.instance.collection('blogs').add({
      ...
      'imageUrls': imageUrls,  // Store imageUrl in the 'blogs' collection (it can be null)
    });
  } catch (e) {
