...
class Comment {
  ...
  final String avatarUrl; // Added avatarUrl field
  ...
  Comment({
    ...
    required this.avatarUrl, // Add avatarUrl to the constructor
  });
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'comment': commentText,
      'timestamp': timestamp,
      'avatarUrl': avatarUrl, // Store avatarUrl in Firestore
    };
  }
  ...
  static Comment fromMap(Map<String, dynamic> map) {
    return Comment(
      ...
      avatarUrl: map['avatarUrl'], // Fetch avatarUrl from the map
    );
  }
}
