...
class _CreateBlogPageState extends State<CreateBlogPage> {
  ...
  Future<void> _createBlog() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        // Call the Firebase service to create the blog with image URL
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(automaticallyImplyLeading: false, // This removes the back button
            ...
            child: Column(
              children: [
                ...
                CustomTextField(
                  ...
                  isContent: true, // Multiline input
                ),
                SizedBox(height: 15),
                CustomDropdown(
